    ...
    <div class="header-container container-xxl">
        ...
        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
            ...
            <h1 class="d-flex flex-column text-dark fw-bold my-1">
                ...
                <small class="text-white fs-3">17 de septiembre del 2022</small>
            </h1>
            <!--end::Heading-->
        </div>
        <!--end::Page title=-->
...
<div class="content d-flex flex-column flex-column-fluid">
    ...
    <div class="container-xxl" >
        ...
        <div class="card card-flush h-md-100" style="text-align: center">
        <!--begin::Header-->
            <div class="card-header pt-7">
                <!--begin::Title-->
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-800">Detalles de Humanos</span>
                </h3>
                <!--end::Title-->
                <!--begin::Toolbar-->
        ...
        <div class="card-body pt-6">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                    ...
                    <thead>
                        <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                            <th class="p-0 pb-3 min-w-100px text-end">Humano</th>
                            <th class="p-0 pb-3 min-w-100px text-end">knino</th>
                        </tr>
                    </thead>
                    <!--end::Table head-->
                    <!--begin::Table body-->
                ...
                <table>
                    <td>
                        <tr>
                            <p>Calle de los Robles #2445</p>
                            <p>C.P.: 47512</p> 
                            <p>Colonia Encinos Zapopan, Jalisco</p>
                        </tr>
                    </td>
                    <td>
                        <tr>
                            <p>33-14-75-82-59</p>
                            <p>adan_gutierrez@gmail.com</p>
                        </tr>
                    </td>
                    <td>
                        <tr>
                            <p>Instagram: AdanGutierrez</p>
                            <p>Tik Tok: AdanGtzMx</p>
                        </tr>
                    </td>
                    <td>
                        <tr>
                            <p>Daniel Contreras Guzmán</p>
                            <p>33-18-45-87-96</p>
                        </tr>
                    </td>
                </table>

            ...
            <div class="table-responsive">
                ...
                <table class="table table-row-bordered table-flush align-middle gy-6">
                    ...
                    <thead class="border-bottom border-gray-200 fs-6 fw-bold bg-lighten">
                        <tr>
                            <th class="min-w-125px ps-9">ID</th>
                            <th class="min-w-125px px-0">HUMANO</th>
                            <th class="min-w-125px">K-NINO</th>
                            <th class="min-w-125px">GENERO</th>
                            <th class="min-w-125px ps-0">RESERVACION <br>Actividad</th>
                        </tr>
                    </thead>
                    <!--end::Thead-->
                    <!--begin::Tbody-->
                    <tbody class="fs-6 fw-semibold text-gray-600">
                        <tr>
                            ...
                            <td class="text-success"><a href="">Detalles</a></td>
                        </tr>
                        <tr>

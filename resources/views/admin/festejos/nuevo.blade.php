    ...
    <div class="container-xxl" id="kt_content_container">
        ...
        <div class="col-xl-12">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <!--begin::Card body-->
                <div class="card-body" style="text-align: center"> <h1>Crear Nuevo Paquete de Festejos</h1>
                    <!--begin::Col-->
                    <div class="col-xxl-4">
                        ...
                        <div class="card h-md-100" style="text-align: center">
                            <form style="text-align: center">
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Cantidad de Noches</label>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="inputCantidad" placeholder="Cantidad de Noches">
                                    </div>
                                </div><br>
                                <div class="form-group row">

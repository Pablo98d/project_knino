                ...
                <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                    ...
                    <thead>
                        <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                            <th class="p-0 pb-3 min-w-60px text-start">ID</th>
                            <th class="p-0 pb-3 min-w-100px text-end">Nombre</th>
                            <th class="p-0 pb-3 min-w-100px text-end">Raza</th>
                            <th class="p-0 pb-3 min-w-175px text-end pe-12">Genero</th>
                            <th class="p-0 pb-3 w-125px text-end pe-7">Validacion</th>
                            <th class="p-0 pb-3 w-50px text-end">Humano</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-end pe-0">
                                <span class="text-gray-600 fw-bold fs-6">Furulais</span>
                            </td>
                            <td class="text-end pe-0">
                                <!--begin::Label-->
                            ...
                            <td class="text-end pe-12">
                                <span class="badge py-3 px-4 fs-7 badge-light-primary">M</span>
                            </td>
                            <td class="text-end pe-12">
                                <span class="badge py-3 px-4 fs-7 badge-light-primary">Correcta</span>
                            </td>
                            <td class="text-end">
                                <a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-50px h-50px">
                            ...
                            <td class="text-end">
                                <a href="{{url('detallesknino')}}" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-20px h20px">
                                    Detalles
                                </a>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-end pe-0">
                                <span class="text-gray-600 fw-bold fs-6">Tyson</span>
                            </td>
                            <td class="text-end pe-0">
                                <!--begin::Label-->
                                <span class="badge badge-light-success fs-base">
                            ...
                            <td class="text-end pe-12">
                                <span class="badge py-3 px-4 fs-7 badge-light-primary">Pendiente</span>
                            </td>
                            <td class="text-end">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
                                    Jose Santos
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-0">
                                <span class="text-gray-600 fw-bold fs-6">Tina</span>
                            </td>
                            <td class="text-end pe-0">
                                <!--begin::Label-->
                                <span class="badge badge-light-success fs-base">
...
<!--end::Content-->
<form action="/my-handling-form-page" method="post" style="text-align: center">
    <ul>Busqueda <br>
     <li>

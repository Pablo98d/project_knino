                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-star pe-3 min-w-100px">Servicio</th>
                            <th class="text-star pe-3 min-w-50px">Talla</th>
                            <th class=" pe-3 min-w-50px">Peso</th>
                            <th class=" pe-3 min-w-80px">Pelaje</th>
                            <th class=" pe-3 min-w-80px">Precio</th>

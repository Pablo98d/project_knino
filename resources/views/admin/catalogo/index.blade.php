										...
										<span class="menu-link menu-center">
											...
											<span class="menu-icon me-0">
												<a href="{{url('hotel')}}">
													...
													<img src="{{asset('assets/img/icono/Hotel.png')}}" alt="" style="width: 100%" title="Hotel">
											...
											<span class="menu-icon me-0">
												...
												<span class="svg-icon svg-icon-2x">
													...
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
														...
														<img src="{{asset('assets/img/icono/Reservaciones.png')}}" alt="" style="width: 100%"></svg>
											...
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
												...
												<span class="menu-link">
													...
													<span class="menu-bullet">
														...
														<img src="{{asset('assets/img/icono/Bienvenida.png')}}" alt="" style="width: 100%">
											...
											<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
												...
												<span class="menu-link">
													...
													<span class="menu-bullet">
														...
														<img src="{{asset('assets/img/icono/Despedida.png')}}" alt="" style="width: 100%">
											...
											<span class="menu-icon me-0">
												...
												<span class="svg-icon svg-icon-2x">
													...
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
														...
														<img src="{{asset('assets/img/icono/Guarderia.png')}}" alt="" style="width: 100%"></svg>
											...
											<span class="menu-icon me-0">
												...
												<span class="svg-icon svg-icon-2x">
													...
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
														...
														<img src="{{asset('assets/img/icono/Estetica.png')}}" alt="" style="width: 100%"></svg>
									...
									<div class="header-search py-3 py-lg-0 me-3">
										...
										<div id="kt_header_search" class="header-search d-flex align-items-center w-lg-250px" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="false" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-end">
											...
											<form data-kt-search-element="form" class="w-100 position-relative" autocomplete="off">
												...
												<!--end::Icon-->
												<!--begin::Input-->
												<input type="text" class="form-control custom-form-control ps-13" name="search" value="" placeholder="Buscar Perro" data-kt-search-element="input" />
												<!--end::Input-->
												<!--begin::Spinner-->
									...
									<div class="row mb-5 mb-xl-8 g-5 g-xl-8">
										...
										<div class="col-6">
											...
											<div class="card card-stretch">
												<!--begin::Link-->
												<a href="{{url('index2')}}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
													<!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
													...
													<!--end::Svg Icon-->
													<span class="fs-4 fw-bold">SERVICIOS</span>
												</a>
												<!--end::Link-->
											</div>
											<!--end::Card-->
										...
										<div class="col-6">
											...
											<div class="card card-stretch">
												<!--begin::Link-->
												<a href="{{url('talla')}}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
										...
										<div class="col-6">
											...
											<div class="card card-stretch">
												<!--begin::Link-->
												<a href="{{url('peso')}}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
													...
													<!--end::Svg Icon-->
													<span class="fs-4 fw-bold">PESO</span>
												</a>
												<!--end::Link-->
											</div>
											<!--end::Card-->
										...
										<div class="col-6">
											...
											<div class="card card-stretch">
												<!--begin::Link-->
												<a href="{{url('pelaje')}}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
													...
													<!--end::Svg Icon-->
													<span class="fs-4 fw-bold">PELAJE</span>
												</a>
												<!--end::Link-->
											</div>
											<!--end::Card-->

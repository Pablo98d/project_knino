...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container-xxl" id="kt_content_container">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table"><br>
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-dark fw-bold">TALLAS</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            <tr>
                                ...
                                <!--end::Product ID-->
                                <!--begin::Date added-->
                                <td class="text-dark fw-bold">mini
                                </td>
                                <!--end::Date added-->
                                <td>
                                    <td>
                                        <span badge py-3 px-4 fs-7 badge-light-primary><a href="{{url('editartalla')}}">Editar</a></span>
                                    </td>
        ...
        <!--end::Col-->
        <!--end::Row-->
        <a href="{{url('nuevatalla')}}" class="btn btn-primary">NUEVA TALLA</a>
    </div>
    <!--end::Container-->

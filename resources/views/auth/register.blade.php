    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-text-input id="NombreUsuario" class="block mt-1 w-full" type="text" name="NombreUsuario" :value="old('NombreUsuario')" required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="ApellidosUsuario" class="block mt-1 w-full" type="text" name="ApellidosUsuario" :value="old('ApellidosUsuario')" required />

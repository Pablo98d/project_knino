					...
					<ul class="navbar-nav mx-auto">
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="menuexperiencias">
								<li>
									<a class="dropdown-item" href="{{route('cliente_exp_guarderia')}}">Guardería</a>
								</li>
							  	<li>
									<a class="dropdown-item" href="{{route('cliente_exp_hotel')}}">Hotel</a>
								</li>
							  	<li>
									<a class="dropdown-item" href="{{route('cliente_exp_estetica')}}">Estética</a>
								</li>
							  	<li>
									<a class="dropdown-item" href="{{route('cliente_exp_festejo')}}">Festejos</a>
								</li>
							</ul>
						</li>
						<li class="nav-item">
							<a href="{{route('cliente_instalaciones')}}" class="nav-link text-white pl-4 text-uppercase">
								Instalaciones
							</a>
						</li>
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="menuexperiencias">
							  	<li>
									<a class="dropdown-item" href="{{route('cliente_historia')}}">Nuestra Historia</a>
								</li>
							  	<li>
									<a class="dropdown-item" href="{{route('cliente_equipo')}}">Únete al Equipo</a>
								</li>
							</ul>
						</li>
						<li class="nav-item">
							<a href="{{route('cliente_preguntas')}}" class="nav-link text-white text-uppercase">
								Preguntas Frecuentes
							</a>
						</li>
						<li class="nav-item">
							<a href="{{route('cliente_ubicacion')}}" class="nav-link text-white text-uppercase">
								Ubicación
							</a>
						</li>
						<li class="nav-item">
							<a href="{{route('cuenta')}}" class="nav-link text-white text-uppercase">
								Cuenta
							</a>
						</li>
					</ul>

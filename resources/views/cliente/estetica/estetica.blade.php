...
@section('header')
	<div class="text-center p-4">
		<h1 class="text-uppercase">Estética</h1>
	</div>
@endsection
	...
	<div class="container p-2">
		<div class="row align-items-center">
			<div class="col-md-6 mx-auto text-center">
				<p>
					Le daremos a tu k-niño un baño a profundidad con los mejores productos, además un rico masaje relajante en nuestras cómodas instalaciones. También tenemos corte de pelo con las mejores técnicas de peluquería para dejarlo lindísimo.
				</p>
			</div>
		</div>
		<div class="row align-items-center">

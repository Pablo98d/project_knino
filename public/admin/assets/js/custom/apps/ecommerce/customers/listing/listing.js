        ...
        e.querySelectorAll(
            '[data-kt-customer-table-filter="delete_row"]'
                ...
                e.addEventListener("click",(function(e){
                    ...
                    Swal.fire({
                        text:"¿Estás seguro de que quieres eliminar el paquete con ID: "+n+"?",
                        icon:"warning",
                        showCancelButton:!0,
                        buttonsStyling:!1,
                        ...
                        e.value?Swal.fire({
                            text:"Has borrado el paquete con ID: "+n+"!.",
                            icon:"success",
                            buttonsStyling:!1,
                            ...
                            formData.append('id_PaqueteHotel', n);
                            $.ajax({
                                ...
                                console.log(data)
                                // if(data=='Guardado'){
                                //     // alert('Paquete agregado con éxito');s
                            ...
                            text:"Paquete con ID: "+n+" no fue eliminado.",
                            icon:"error",
                            buttonsStyling:!1,
                            confirmButtonText:"Ok, entendido!",
                            customClass:{

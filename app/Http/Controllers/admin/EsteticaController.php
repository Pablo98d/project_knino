...
class EsteticaController extends Controller
{
    ...
    // Capacidad
        ...
        public function guardar_capacidad(Request $request){

            if ($request->id_Capacidad=='Insertar') {

                $capacidad= Capacidad::create($request->all());
        
                $guardado = $capacidad->save();
                ...
                $capacidad = Capacidad::find($request->id_Capacidad);
                $capacidad->Turno = $request->Turno;
                $capacidad->Lunes = $request->Lunes;
                $capacidad->Martes = $request->Martes;
                $capacidad->Miercoles = $request->Miercoles;
                $capacidad->Jueves = $request->Jueves;
                $capacidad->Viernes = $request->Viernes;
                $capacidad->Sabado = $request->Sabado;
                $capacidad->Domingo = $request->Domingo;
                $updated = $capacidad->save();
        ...
        public function eliminar_capacidad(Request $request){
            $eliminar=Capacidad::destroy($request->id_Capacidad);
